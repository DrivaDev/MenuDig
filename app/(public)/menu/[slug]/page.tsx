      ...
      <div className="sm:max-w-lg md:max-w-2xl sm:mx-auto">
        ...
        <header className={`bg-brand-fondo px-4 py-8 sm:px-8 sm:py-10 flex flex-col gap-3 ${headerAlign}`}>
            ...
            <div className={`flex gap-4 mt-1 ${logoPosition === 'center' ? 'justify-center' : ''}`}>
              ...
              {serializedRestaurant.instagramUrl && (
                <a href={serializedRestaurant.instagramUrl} target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                  <svg viewBox="0 0 24 24" className="w-6 h-6" fill="#E1306C" xmlns="http://www.w3.org/2000/svg">
              ...
              {serializedRestaurant.googleMapsUrl && (
                <a href={serializedRestaurant.googleMapsUrl} target="_blank" rel="noopener noreferrer" aria-label="Ubicación en Google Maps">
                  <svg viewBox="0 0 24 24" className="w-6 h-6" fill="#EA4335" xmlns="http://www.w3.org/2000/svg">
          ...
          {serializedRestaurant.wifiName && serializedRestaurant.wifiPassword && (
            <div className={`flex items-center gap-2 mt-1 ${logoPosition === 'center' ? 'justify-center' : ''}`}>
              <svg viewBox="0 0 24 24" className="w-4 h-4 shrink-0 text-brand-texto" fill="none" stroke="currentColor" strokeWidth={2} xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="text-sm font-normal text-brand-texto">
                ...
                <span className="text-brand-texto/50">|</span>{' '}
